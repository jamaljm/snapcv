    ...
    <div className="w-full h-screen px-7 flex flex-col justify-between items-center ">
      ...
      {aiCreating ? (
        ...
        <div className="max-w-xl -mt-20 rounded-3xl  min-h-64 w-full flex flex-col justify-start items-center">
          ...
          <button
            onClick={generateai}
            className="mt-8 z-50 w-full hover:opacity-85 hover:scale-105 transform-gpu max-w-sm flex justify-center items-center gap-2 font-urbanist bg-black/80 text-white font-semibold  transition-transform duration-500 ease-in-out text-base rounded-xl py-2.5"
            style={{
              backgroundImage: `
