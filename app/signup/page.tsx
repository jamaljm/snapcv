  ...
  return (
    <>
      ...
      <div className=" flex  flex-col h-full p-6 z-40 w-full absolute justify-center  items-center  overflow-hidden rounded-lg ">
        <BlurFade
          className="max-w-sm  sm:max-w-lg  w-full justify-center items-center flex  rounded-xl h-full"
          duration={0.1}
          delay={0.05}
          blur="1px"
        >
          {" "}
          <div className="py-10 pt-5 px-6 max-w-sm  sm:max-w-lg border w-full justify-center items-center flex flex-col rounded-xl bg-white min-h-64">
            <BlurFade
