      ...
      <div className="mx-auto max-w-2xl px-6 py-16 sm:py-24">
        ...
        <ul className="mt-5 space-y-4 text-neutral-700">
          <li>
            ...
            You can self-host it if you ever want to — your profile isn&apos;t
            hostage to a startup&apos;s roadmap.
          </li>
          <li>
            <strong>Start from what you already have.</strong> Upload a résumé PDF
            or just type your GitHub username, and you get a real page in seconds
            — no blank canvas.
          </li>
          <li>
          ...
          <li>
            ...
            <span className="font-semibold">yourname.snapcv.me</span> — easy to
            drop in a bio, a DM, or an application.
          </li>
        </ul>
        ...
        <ol className="mt-5 space-y-3 text-neutral-700 list-decimal pl-5">
          ...
          <li>Tweak anything, hit save — your page is live.</li>
        </ol>
