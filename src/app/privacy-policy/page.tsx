...
export default function page() {
  return (
    <div className="p-12 border rounded-3xl">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to snapCV.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to snapCV, accessible from{" "}
            <a
              href="www.snapcv.me"
      ...
      <ul>
        <li>By email: jamalvga2002@gmail.com</li>
      </ul>
    </div>
  );
}
