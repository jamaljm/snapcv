...
const ResumeTemplate: React.FC<ResumeTemplateProps> = ({ profile }) => {
  return (
    <div
      id="resume-template"
      className=" sm:border sm:scale-110 sm:mt-24 sm:mb-24 mt-6 sm:border-gray-200 m-2 sm:rounded-lg  max-w-2xl font-quattrocento mx-auto  text-gray-800 leading-relaxed p-5 text-sm"
    >
        ...
        <section className="mb-4">
          ...
          {profile.work.map((work, index) => (
            <div key={`workResume-${index}`} className="mb-3 ml-2">
              ...
              {work.summary && <p className="text-xs">{work.summary}</p>}
              {work.highlights &&
        ...
        <section className="mb-4">
          ...
          <div className="flex flex-wrap">
            {profile.skills.map((skill, index) => (
              <div key={`skillResume-${index}`} className="w-1/2 mb-2 ml-2">
          ...
          <section className="mb-4">
            ...
            {profile.certificates.map((cert, index) => (
              <div key={`certificateResume-${index}`} className="mb-2 ml-2">
                ...
                {cert.date && <p className="text-xs">Date: {cert.date}</p>}
                {cert.url && (
                  <p>
                    <a
                      href={cert.url}
          ...
          <section className="mb-4">
            ...
            {profile.awards.map((award, index) => (
              <div key={`awardResume-${index}`} className="mb-2 ml-2">
                ...
                {award.date && <p className="text-xs">Date: {award.date}</p>}
          ...
          <section className="mb-4">
            ...
            <div className="flex flex-wrap">
              {profile.languages.map((lang, index) => (
                <p
                  key={`languageResume-${index}`}
                  className="mr-5 text-xs ml-2"
                >
