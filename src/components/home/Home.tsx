      ...
      >
        <div className="flex w-full justify-center items-center p-6 border-b">
          <div className="flex gap-2 w-full">
            <Link
              target="_blank"
              className="flex-1 bg-white text-slate-950 font-medium px-4 py-2 text-sm justify-center items-center flex rounded-xl cursor-pointer hover:bg-slate-100 transition-colors duration-200 border border-slate-200 text-center"
              href={`https://${user.meta.userName}.snapcv.me`}
            >
              View Portfolio
              <svg
            ...
            <Link
              target="_blank"
              className="flex-1 bg-white text-slate-950 font-medium px-4 py-2 text-sm justify-center items-center flex rounded-xl cursor-pointer hover:bg-slate-100 transition-colors duration-200 border border-slate-200 text-center"
              href={`https://${user.meta.userName}.snapcv.me/resume`}
            >
              View Resume
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {githubData === null ? (
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  ...
                  className="w-full px-4 flex-1  py-2 text-sm border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-slate-400"
                />
                <button
                ...
                >
                  ...
                  {githubLoading ? "Generating..." : "Generate GitHub Wrap"}
                </button>
              </div>
            </div>
          ) : (
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link
                  href={`https://${user.meta.userName}.snapcv.me/github`}
