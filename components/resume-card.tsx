          ...
          <CardHeader>
            <div className="flex items-center font-dmSans justify-between gap-x-2 text-base">
              <h3 className="inline-flex items-center justify-center font-semibold leading-none text-sm sm:text-sm">
                {title}
                {badges && (
                  <span className="inline-flex gap-x-1 mt-.05">
            ...
            {subtitle && (
              <div className="font-dmSans text-slate-900  text-xs">
                {subtitle}
              </div>
            )}
            <div className="text-xs  min-w-20 font-dmSans sm:text-sm tabular-nums text-muted-foreground text-left mt-1">
              {period}
            </div>
          </CardHeader>
          <CardContent className="mt-2 text-xs/relaxed font-dmSans text-black/95 font-light text-gray-600 sm:text-sm/relaxed">
            {description}
          </CardContent>
        </div>
      </Card>
